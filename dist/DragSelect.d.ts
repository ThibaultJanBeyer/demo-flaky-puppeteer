...
declare class SelectableSet<E extends DSInputElement> extends Set<E> {
    ...
    getRect: (element: E) => DSBoundingRect | DOMRect | undefined;
    get elements(): E[];
...
type MutationCallbackEvent = UIEvent | Event | MutationRecord[];
...
declare class DropZones<E extends DSInputElement> {
    ...
    getTarget: (coordinates?: Vect2) => DropZone<E> | undefined;
}
...
type DSPubCallback<T extends keyof DSPublicPublish<E>, E extends DSInputElement> = DSCallback<DSPublishMappings<E>[T]>;
